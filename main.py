...
parser.add_argument('--dir_data', type=str, default='C:/Users/Brook/A/GITHUB/traffic_lights_classifier/data/sim/train', help='path of Raw Dataset.')
...
parser.add_argument('--checkpoint_dir', type=str, default="C:/Users/Brook/A/GITHUB/traffic_lights_classifier/saved_weights", help='place to store and reload checkpoints.')
parser.add_argument('--weights_name', type=str, default='tl_weights_classifier_sim.h5', help='name of saved weights in the path of ckpt')
...
parser.add_argument('--dir_test_imgs', type=str, default='C:/Users/Brook/A/GITHUB/traffic_lights_classifier/data/sim/test', help='path of testing Dataset.')
parser.add_argument('--dir_test_results', type=str, default='C:/Users/Brook/A/GITHUB/traffic_lights_classifier/data/sim/test_results', help='path of reults of testing Dataset.')
...
### Step 4 predict
    ...
    for i in range(len(prediction)):
        ...
        print ('Index: ', i, 'Predicted probability: ', prediction[i], 'Predicted label: ', label_dict[max_index])
        plt.imshow(Y_test[i])
        plt.show()
